      ...
      <div className="  bg-green-400 h-[91vh] flex flex-col">
        <div className="flex flex-col justify-center items-center p-5  ">
          ...
          <form
            ...
            className="flex flex-col p-10 rounded-md bg-green-700"
          >
            <input
            ...
            />
            <button
              className="bg-pink-400 m-2 p-1 font-bold rounded-lg"
              type="submit"
            >
              Submit
            </button>
          ...
          <div className="flex flex-col justify-center items-center bg-green-400 p-5  ">
            ...
            {urldata ? (
              urldata.map((url, index) => (
                <div key={index} className=" flex p-2 m-1 rounded-md bg-green-700">
                  <h1 className="px-2" >
                    Original URL: {url.originalUrl}{" "}
                  </h1>
                  <h1 className="px-2"> Short ID: {url.shortUrl} </h1>
                  <h1 className="px-2"> Clicks: {url.noOfClicks || 0}</h1>
                  <a
